...
class PromoDuck extends Enemy
{
    ...
    Check()
    {
        ...
        if(this.check == 1)
            result.speech = ['О дааааа!!! Это всё ПРАВДА. %ОСОБЕННО ПОСЛЕДНЕЕ!!'];
        ...
        switch(this.bet)
        {
            case 1:
                return {
                    ...
                    speech: ['Один карандаш???? НЕ СМЕШИ, Я ЕГО ТОЛЬКО ПОГРЫЗТЬ МОГУ!', 'Короч, смотри...&0', '@2Триста тыщ@ карандашей против одного твоего. Сечёшь?'],
                    actions: [
